CREATE TABLE [dbo].[HouseHold_CRMResults]
(
...
[SSB_CRMSYSTEM_HOUSEHOLD_ID__c] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[ResultDateTime] [datetime] NULL CONSTRAINT [DF__HouseHold_C__Resul__51300E55] DEFAULT (getdate())
)
GO
