...
INSERT INTO wrk.customerWorkingList (DimCustomerID, [SSB_CRMSYSTEM_CONTACT_ID], SSB_CRMSYSTEM_ACCT_ID, SSB_CRMSYSTEM_HOUSEHOLD_ID,IsPersonAccount, IsBusinessAccount, MDM_UpdatedDate, CRMProcess_UpdatedDate
...
,dc.SSB_CRMSYSTEM_HOUSEHOLD_ID --Needs to be added to composite view
