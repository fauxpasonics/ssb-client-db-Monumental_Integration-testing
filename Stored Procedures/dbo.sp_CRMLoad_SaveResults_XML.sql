...
IF @ResultCategory = 'Household_Custom'
SET @XML = (SELECT * FROM dbo.[Lead_Custom_CRMResults] FOR XML RAW('Household_Custom'), ELEMENTS, ROOT('Root'))

IF @ResultCategory = 'Household_Std'
SET @XML = (SELECT * FROM dbo.[Lead_Custom_CRMResults] FOR XML RAW('Household_Std'), ELEMENTS, ROOT('Root'))
