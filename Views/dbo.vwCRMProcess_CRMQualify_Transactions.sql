...
AS
SELECT b.SSB_CRMSYSTEM_ACCT_ID, b.SSB_CRMSYSTEM_CONTACT_ID, b.DimCustomerId, b.SSB_CRMSYSTEM_HOUSEHOLD_ID
, [b].[SourceSystem]
...
GROUP BY b.SSB_CRMSYSTEM_ACCT_ID, b.SSB_CRMSYSTEM_CONTACT_ID, b.DimCustomerId, b.Sourcesystem, b.SSB_CRMSYSTEM_HOUSEHOLD_ID
GO
