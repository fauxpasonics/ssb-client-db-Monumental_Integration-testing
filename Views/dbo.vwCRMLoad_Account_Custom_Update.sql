...
INNER JOIN dbo.[Household_Custom] b ON [a].[SSB_CRMSYSTEM_HOUSEHOLD_ID__c] = b.[SSB_CRMSYSTEM_HOUSEHOLD_ID]
INNER JOIN dbo.HOUSEHOLD z ON a.[SSB_CRMSYSTEM_HOUSEHOLD_ID__c] = z.[SSB_CRMSYSTEM_HOUSEHOLD_ID]
LEFT JOIN  prodcopy.Account c ON z.[crm_id] = c.ID
WHERE z.[SSB_CRMSYSTEM_HOUSEHOLD_ID] <> z.[crm_id]
--AND  (1=2
